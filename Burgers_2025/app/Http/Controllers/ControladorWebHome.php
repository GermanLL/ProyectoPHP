     ...
     public function insertar(Request $request)
    {
        ...
        if (isset($idCliente) && $idCliente > 0) {
                ...
                if (isset($cantidad) && $cantidad > 0) {
                    ...
                    $msg["MSG"] = "El combo ha sido agregado al carrito";
                    return view("web.index", compact("msg", "aCategorias", "aSucursales", "aProductos"));
                } else {
                    $msg["ESTADO"] = MSG_ERROR;
                    $msg["MSG"] = "No ha agregado ningun combo al carrito";
                    return view("web.index", compact("msg", "aCategorias", "aSucursales", "aProductos"));
                }
        } else {
            $msg["ESTADO"] = MSG_ERROR;
